...
Learn more in [Edge Bars](/cards-list/edge-bars).
...
See the [File Format Guide](/sync-export-import/file-format/) for detailed specifications.

---

## Related Topics

- [Export Cards](/sync-export-import/export-cards) - Create a new Excel/CSV file from a deck
- [Import Cards](/sync-export-import/import-cards) - Create a deck from an existing file
- [File Format](/sync-export-import/file-format) - Understand the required file structure
- [Why Use Excel/CSV](/sync-export-import/why-use-excel-csv) - Benefits of computer editing
- [Auto-Sync](/study/auto-sync) - Enable automatic syncing during study sessions